...
LIBS += -L$$PWD/U1000/Lib/lib_x64 -lcdll8
...
win32 {
    ...
    U1000_DLL = $$shell_path($$PWD/U1000/Lib/lib_x64/cdll8.dll)
    OUT_U1000_DLL = $$shell_path($$DESTDIR/cdll8.dll)
    QMAKE_POST_LINK = $$quote(copy /Y "$$SDK_DLL" "$$OUT_SDK_DLL") $$escape_expand(\n\t) $$quote(copy /Y "$$U1000_DLL" "$$OUT_U1000_DLL")
}
